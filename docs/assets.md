...
Текущий первый экран использует цельную иллюстрацию, созданную и отредактированную встроенным ImageGen. У кондиционера удалены все черты лица, анатомия птицы исправлена до двух лап. Окно распахнуто, птица сидит на внешнем краю подоконника; комната, израильская застройка и вечерний свет сохранены. Это иллюстрация, а не фотография выполненной работы.

- `public/images/quiet-apartment-open.webp` — сцена с открытым окном, 1536×1024.
- `public/images/quiet-apartment-open-768.webp` — её мобильная версия, 768×512.
- Прежние `quiet-apartment.webp`, `quiet-apartment-768.webp` , `quiet-apartment-awake.webp` и `quiet-apartment-natural*.webp` — архивные варианты, больше не подключённые к странице.
...
Точные финальные промпты и режим генерации: [character-assets.json](character-assets.json). Изображения конвертированы в WebP через cwebp; версия с открытым окном — через Pillow. Персонаж и его реплики используются только на первом экране.
