...
- Telegram: `https://t.me/+972524464677`.
...
WhatsApp подключён к основному телефону компании: `+972524464677`. Основной номер задаётся первым в `company.phones`; WhatsApp и Telegram используют его автоматически. `info@example.com` и `t.me/yourusername` не перенесены. Таблица источников и решений: `docs/reference.md`.
